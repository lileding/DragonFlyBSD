...
#define VMMFS_PCISLOT_DESCRIPTOR_MAX 32768
#define VMMFS_PCISLOT_MAX_BARS VMMFS_PCI_MAX_BARS
#define VMMFS_PCISLOT_MAX_DOORBELLS VMMFS_PCI_MAX_DOORBELLS
#define VMMFS_PCISLOT_MAX_CONFIGS VMMFS_PCI_MAX_CONFIGS
#define VMMFS_PCISLOT_MAX_MSIX_VECTORS 2048
#define VMMFS_PCISLOT_MAX_CAPS VMMFS_PCI_MAX_CAPS
#define VMMFS_PCISLOT_MAX_ECAPS VMMFS_PCI_MAX_ECAPS
#define VMMFS_PCISLOT_CAP_DATA_MAX VMMFS_PCI_MAX_DATA
