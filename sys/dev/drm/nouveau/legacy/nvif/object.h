...
#define nvif_rd08(a,b) ({ ((u8)nvif_rd((a), nvkm_ioread8, 1, (b))); })
#define nvif_rd16(a,b) ({ ((u16)nvif_rd((a), nvkm_ioread16, 2, (b))); })
#define nvif_rd32(a,b) ({ ((u32)nvif_rd((a), nvkm_ioread32, 4, (b))); })
#define nvif_wr08(a,b,c) nvif_wr((a), nvkm_iowrite8, 1, (b), (u8)(c))
#define nvif_wr16(a,b,c) nvif_wr((a), nvkm_iowrite16, 2, (b), (u16)(c))
#define nvif_wr32(a,b,c) nvif_wr((a), nvkm_iowrite32, 4, (b), (u32)(c))
