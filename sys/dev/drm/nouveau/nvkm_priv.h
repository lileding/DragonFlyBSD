...
struct nvkm_softc {
	...
	uint32_t		kms_atomic_last_lock_core;
	uint32_t		kms_atomic_last_flush_disable;
	uint32_t		kms_atomic_last_old_active_heads;
	uint32_t		kms_atomic_last_new_active_heads;
	uint32_t		kms_atomic_last_modeset_heads;
	uint32_t		kms_atomic_last_disable_heads;
	uint32_t		kms_atomic_last_enable_heads;
	uint32_t		kms_atomic_last_primary_update_heads;
	uint32_t		kms_atomic_last_primary_disable_heads;
	uint32_t		kms_atomic_last_cursor_update_heads;
	uint32_t		kms_atomic_last_cursor_disable_heads;
	uint32_t		kms_atomic_last_plane_update_mask;
	uint32_t		kms_atomic_last_plane_disable_mask;
	uint32_t		kms_atomic_last_prepared_heads;
	uint32_t		kms_atomic_last_prepared_displays;
	...
	uint64_t		vmm_pte_skip_clear_count[NVKM_DRM_VM_BIND_PAGE_SHIFT_COUNT];
	uint64_t		vmm_pte_skip_clear_pages[NVKM_DRM_VM_BIND_PAGE_SHIFT_COUNT];
	uint64_t		vmm_pte_conflict_clear_count[NVKM_DRM_VM_BIND_PAGE_SHIFT_COUNT];
	uint64_t		vmm_pte_conflict_clear_pages[NVKM_DRM_VM_BIND_PAGE_SHIFT_COUNT];
	uint64_t		vmm_pte_final_clear_count[NVKM_DRM_VM_BIND_PAGE_SHIFT_COUNT];
	uint64_t		vmm_pte_final_clear_pages[NVKM_DRM_VM_BIND_PAGE_SHIFT_COUNT];
	...
	uint64_t		vmm_pt_conflict_clear_count;
	uint64_t		vmm_pt_conflict_clear_pages;
	uint64_t		vmm_pt_final_clear_count;
	uint64_t		vmm_pt_final_clear_pages;
