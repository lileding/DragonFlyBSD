...
#define NVGSP_DFLY_DISPLAY_ONLY 1
#include "nvgsp_abi.h"

#define NV_ALIGN_BYTES(alignment) __attribute__((__aligned__(alignment)))
#ifndef NV_DECLARE_ALIGNED
#define NV_DECLARE_ALIGNED(field, alignment) field __attribute__((__aligned__(alignment)))
#endif
...
typedef struct NV2080_CTRL_INTERNAL_DISPLAY_GET_STATIC_INFO_PARAMS {
    ...
    NvU32  numHeads;
#ifdef NVGSP_DFLY_DISPLAY_ONLY
    /*
     * r570.144 FINN layout.  The imported display body is still mostly r535,
     * so keep this at the import edge until the full r570 display API is
     * staged.
     */
    NvU32  i2cPort;
...
#ifdef NVGSP_DFLY_DISPLAY_ONLY
#define NV0073_CTRL_CMD_SYSTEM_GET_SUPPORTED (0x730107U) /* r570.144 */
#else
...
#ifdef NVGSP_DFLY_DISPLAY_ONLY
#define NV0073_CTRL_CMD_SYSTEM_GET_CONNECT_STATE (0x730108U) /* r570.144 */
#else
...
#ifdef NVGSP_DFLY_DISPLAY_ONLY
#define NV0073_CTRL_CMD_SYSTEM_GET_ACTIVE                (0x73010cU) /* r570.144 */
#else
