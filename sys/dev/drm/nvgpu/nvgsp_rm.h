...
int nvgsp_rm_client_create(struct nvgpu_device *gpu);
/* Create the RM device object under the client. */
int nvgsp_rm_device_create(struct nvgpu_device *gpu);
/* Create the RM subdevice object for GPU-wide controls. */
int nvgsp_rm_subdevice_create(struct nvgpu_device *gpu);
