...
/* Convert userspace wait syncobjs into future wait callbacks. */
int nvdrm_sync_collect_waits(struct drm_file *file,
    struct nvgpu_future *future, uint32_t count, uint64_t wait_ptr);
