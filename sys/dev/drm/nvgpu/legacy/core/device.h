...
#define nvkm_rd08(d,a) nvkm_ioread8((d)->pri + (a))
#define nvkm_rd16(d,a) nvkm_ioread16((d)->pri + (a))
#define nvkm_rd32(d,a) nvkm_ioread32((d)->pri + (a))
#define nvkm_wr08(d,a,v) nvkm_iowrite8((v), (d)->pri + (a))
#define nvkm_wr16(d,a,v) nvkm_iowrite16((v), (d)->pri + (a))
#define nvkm_wr32(d,a,v) nvkm_iowrite32((v), (d)->pri + (a))
