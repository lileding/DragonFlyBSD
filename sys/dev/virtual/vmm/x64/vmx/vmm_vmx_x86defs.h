 ...
 *
 * Intel VMX x86 CPUID and control-register definitions used by VMM VMX.
 *
 * Copyright (c) 2018-2021 Maxime Villard, m00nbsd.net
 *
 * Derived from the BSD-2-Clause NVMM x86 ABI definitions, retaining the
 * architecture spellings so the imported VMX backend remains reviewable.
 */
#ifndef VMM_VMX_X86DEFS_H
#define VMM_VMX_X86DEFS_H
