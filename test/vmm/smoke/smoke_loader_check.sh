...
MODES=${VMM_SMOKE_LOADER_MODES:-"vmmcall cpuid msrpatch msrsyscfg mtrrcap msrhwcr pcicfg pitfallback pit0 rtccmos iodelay serial serialin serialirq time xsetbv apicmsr timerint lapictimer ud pic ioapic x2apic cachetlb pm64 avicirq avicipi aviclvt avictimercfg aviclint aviclvtpc avicesr avicsvr avicnoaccel hlt loop cliloop"}
