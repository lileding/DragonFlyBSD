...
MODES=${VMM_SMOKE_LOADER_MODES:-"vmmcall cpuid msrpatch msrsyscfg mtrrcap msrhwcr pcicfg pitfallback serial serialin serialirq time xsetbv apicmsr timerint ud pic ioapic x2apic cachetlb pm64 avicirq avicipi aviclvt avictimercfg aviclint avicnoaccel hlt loop cliloop"}
