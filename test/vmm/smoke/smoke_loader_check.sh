...
MODES=${VMM_SMOKE_LOADER_MODES:-"vmmcall cpuid msrpatch msrsyscfg serial serialin serialirq time xsetbv apicmsr timerint ud pic ioapic x2apic cachetlb pm64 avicirq avicipi avicnoaccel hlt loop cliloop"}
