...
MODES=${VMM_SMOKE_LOADER_MODES:-"vmmcall cpuid msrpatch msrsyscfg mtrrcap msrhwcr pcicfg pitfallback pit0 rtccmos rtc_settime iodelay elcr serial serialin serialirq time xsetbv apicmsr timerint lapictimer lapictimer_masked ud mwaitxud pic ioapic ioapicirq x2apic cachetlb pm64 avicirq avicipi aviclvt avictimercfg aviclint aviclvtpc avicesr avicsvr avicnoaccel avicread hlt loop cliloop acpi_s5"}
