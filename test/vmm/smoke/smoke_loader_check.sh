...
MODES=${VMM_SMOKE_LOADER_MODES:-"vmmcall cpuid serial serialin serialirq time xsetbv apicmsr timerint ud pic ioapic x2apic cachetlb pm64 msrpatch avicirq avicipi avicnoaccel hlt loop cliloop"}
