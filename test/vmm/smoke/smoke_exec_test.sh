...
MODES="vmmcall cpuid msrpatch msrsyscfg serial serialin serialirq time xsetbv apicmsr timerint ud pic ioapic x2apic cachetlb pm64 hlt loop"
SELF_EXIT_MODES="vmmcall cpuid msrpatch msrsyscfg serial serialin serialirq time xsetbv apicmsr timerint ud pic ioapic x2apic cachetlb pm64"
